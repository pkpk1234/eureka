 ...
 *
 * <p>In this example, the program tries to get the example from the EurekaClient, and then makes a
 * REST call to a supported service endpoint
 */
public class ExampleEurekaClient {
  ...
  public void sendRequestToServiceUsingEureka(EurekaClient eurekaClient) {
    ...
    System.out.println(
        "Found an instance of example service to talk to from eureka: "
